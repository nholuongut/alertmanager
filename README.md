...
Docker images are available on [Quay.io](https://github.com/nholuongut/alertmanager).

You can launch an Alertmanager container for trying it out with

    $ docker run --name alertmanager -d -p 127.0.0.1:9093:9093 quay.io/nholuongut/alertmanager
...
```
$ GO15VENDOREXPERIMENT=1 go get github.com/nholuongut/alertmanager/cmd/...
# cd $GOPATH/src/github.com/nholuongut/alertmanager
...
$ git clone https://github.com/nholuongut/alertmanager.git
$ cd alertmanager
$ make build
$ ./alertmanager --config.file=<your_file>
```
...
accessed [here](http://petstore.swagger.io/?url=https://raw.githubusercontent.com/nholuongut/alertmanager/main/api/v2/openapi.yaml).
...
```
$ go install github.com/nholuongut/alertmanager/cmd/amtool@latest
```
...
Check the [Prometheus contributing page](https://github.com/nholuongut/prometheus/blob/main/CONTRIBUTING.md).
