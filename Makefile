...
SWAGGER = docker run \
	...
	--rm \
	-v $(shell pwd):/go/src/github.com/nholuongut/alertmanager \
	-w /go/src/github.com/nholuongut/alertmanager quay.io/goswagger/swagger:v0.30.5
...
# actions currently have a bug, see https://github.com/nholuongut/alertmanager/pull/3299
