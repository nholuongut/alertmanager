...
[Alertmanager](https://github.com/nholuongut/alertmanager) is configured via
...
A provided [valid example file](https://github.com/nholuongut/alertmanager/blob/main/doc/examples/simple.yml)
