...
The [Alertmanager](https://github.com/nholuongut/alertmanager) handles alerts
...
This can be configured using the [--cluster-*](https://github.com/nholuongut/alertmanager#high-availability) flags.
